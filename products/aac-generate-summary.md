...
|---|---------|-------|------------|-----|---------|---------|--------|
| 1 | Azure Architecture | 445 | 333 | 0 | 10 | 0 | OK |

### Totals

- **Products Processed**: 1 success, 0 failed
- **Total Pages**: 445
- **Total Classified**: 333
- **Total New Pages**: 0
- **Total Updated Pages**: 10
...
| best-practices | 48 |
| design-patterns | 48 |
| example-workloads | 75 |
| migration-guides | 32 |
| reference-architectures | 54 |
| solution-ideas | 27 |
| technology-choices | 30 |
...
- **Status**: active
- **TOC URL**: https://learn.microsoft.com/en-us/azure/architecture/toc.json
