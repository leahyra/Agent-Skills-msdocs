...
category_descriptions:
  ...
  best-practices: Guidance on client usage, resilience, scaling, memory/CPU tuning,
    Kubernetes optimization, failover/patching, and performance testing for Azure
    Cache for Redis and Enterprise tiers
  ...
  troubleshooting: 'Diagnosing and fixing Azure Cache for Redis issues: client and
    connectivity errors, data loss, server-side problems, and performance, latency,
    and timeout troubleshooting.'
  deployment: Scaling, upgrading, region-moving, and ARM/Bicep-based deployment of
    ...
    steps.
  decision-making: Guidance on sizing and capacity, choosing tiers and reservations,
    planning migrations (including VNet to Private Link), and selecting network isolation
    options for Azure Cache for Redis.
skill_description: Expert knowledge for Azure Cache for Redis development including
  troubleshooting, best practices, decision making, architecture & design patterns,
  security, configuration, integrations & coding patterns, and deployment. Use when
  configuring geo-replication, persistence, Private Link/VNet access, Redis events/webhooks,
...
use_when: Use when configuring geo-replication, persistence, Private Link/VNet access,
  Redis events/webhooks, or ARM/Bicep deployments, and other Azure Cache for Redis
...
| [Azure Cache for Redis retirement FAQ](https://learn.microsoft.com/en-us/azure/azure-cache-for-redis/retirement-faq) | decision-making | 0.70 | Retirement FAQ for specific tiers (Basic, Standard, Premium, Enterprise, Enterprise Flash) will contain concrete timelines, tier-specific implications, and guidance on when/how to move to Azure Managed Redis. This is specialized decision-making content about service/tier selection and migration paths with product-specific constraints. |
