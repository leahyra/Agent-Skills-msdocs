...
|-----------|------|------------|--------|
| [Peering service prefix requirements](https://learn.microsoft.com/en-us/azure/peering-service/peering-service-prefix-requirements) | best-practices | 0.70 | Described as technical requirements to optimize prefixes before activation; such pages typically include concrete, product-specific constraints (for example, prefix sizes, routing/AS path requirements, allowed/blocked configurations), which are actionable DO/DON'T guidance unique to the service. |
...
| [Azure portal](https://learn.microsoft.com/en-us/azure/peering-service/azure-portal) | 0.40 | Portal how-to for creating/changing/deleting a connection; primarily step-by-step UI instructions without indication of comprehensive configuration parameter tables or expert-only constraints. |
