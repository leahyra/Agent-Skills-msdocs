...
|---|---------|-------|------------|-----|---------|---------|--------|
| 1 | Azure Well Architected | 230 | 200 | 1 | 4 | 1 | OK |

### Totals

- **Products Processed**: 1 success, 0 failed
- **Total Pages**: 230
- **Total Classified**: 200
- **Total New Pages**: 1
...
- **Status**: active
- **TOC URL**: https://learn.microsoft.com/en-us/azure/well-architected/toc.json
