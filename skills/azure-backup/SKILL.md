...
| Limits & Quotas | L96-L132 | Limits, support matrices, regions, performance, and retention constraints for Azure Backup across VMs, databases, files, disks, blobs, AKS, and SAP workloads |
